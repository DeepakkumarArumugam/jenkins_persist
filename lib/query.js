...
var noPasswordError = function () {
  u.log(colors.red('Error: Set password with ') +
        colors.red.underline('MYSQL_PASSWORD') +
        colors.red(' environment variable.'))
}
 ...
 */
exports.build = function queryBuild () {
 ...
 */
exports.init = function queryIniti (flag) {
  if (!process.env.MYSQL_PASSWORD) {
    noPasswordError()
    process.exit()
  }
 ...
 */
exports.release = function queryRelease () {
  if (!process.env.MYSQL_PASSWORD) {
    noPasswordError()
    process.exit()
  }
